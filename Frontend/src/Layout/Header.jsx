            ...
            <nav className="hidden md:block">
              <ul className="flex space-x-8">
                ...
                <li>
                  ...
                  >
                    <MdAddIcCall className="inline-block mr-1 text-xl mb-1" />{" "}
                    Contact Us
                  </NavLink>
                </li>
              </ul>
              ...
              <div className="absolute top-full left-0 w-full bg-[#1e293b] border-t border-gray-700 shadow-lg sm:hidden z-50">
                <ul className="flex flex-col p-4 space-y-3">
                  ...
                  <li>
                    ...
                    >
                      <MdAddIcCall className="text-xl" /> Contact Us
                    </NavLink>
                  </li>
                </ul>
              </div>
        ...
        <div className="fixed inset-0 z-[100] sm:hidden">
            ...
            <form onSubmit={handleSearchSubmit} className="flex items-center space-x-3">
              <div className="relative flex-1">
                <input
                  ...
                  value={searchQuery}
                  onChange={handleSearchChange}
                  className="w-full bg-white/10 backdrop-blur-md text-gray-200 placeholder-gray-400 rounded-lg pl-10 pr-10 py-3 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
                  autoFocus
                />
          ...
          <div className="relative bg-[#1e293b]/95 h-full p-4 overflow-y-auto">
            <div className="text-center text-gray-400 mt-8">
              <p>{searchQuery ? 'Press Enter to search...' : 'Start typing to search...'}</p>
            </div>
          </div>
        </div>
      )}
